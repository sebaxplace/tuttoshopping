...
$sql = "SELECT * FROM vista_offerte WHERE id = ".$idOfferta." AND Abilita = 1 AND Data_da <= '".$dataoggi."'";
...
if ($row_count === 0){
	...
	$sql2 = "SELECT * FROM opzione WHERE offerta = ".$row['id']." AND Abilita = 1 ORDER BY Prezzo_al_Pubblico ASC";
	...
	$offerta[] = array(
		...
		'indirizzo2' => $row3['Indirizzo2'],
		'indirizzo3' => $row3['Indirizzo3'],
		'citta1' => $row3['Citta'],
		'citta2' => $row3['Citta2'],
		'citta3' => $row3['Citta3'],
