...
if($conn){
	$sql2 = "SELECT * FROM vista_offerte WHERE (Data_da < '".$dataoggi."' OR (Data_da = '".$dataoggi."' and replace(Ora_di_Attivazione, ':','') >= '".$oraoggi."')) AND Abilita = 1 ".$consultaciudad." AND Categoria ='1'";
